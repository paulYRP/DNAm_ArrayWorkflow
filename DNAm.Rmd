...
# ENmix: Quality Control Plots

```{r, echo=F, include=T, out.width="100%"}
# Path to folder
img_dir <- "figures/preprocessingMinfiEwasWater/enMix/"
...
# Minfi: Pre-processing and Filtering

```{r, echo=F, include=T, out.width="100%"}
# Folder with TIFFs
dir <- "figures/preprocessingMinfiEwasWater/qc/"
...
# Minfi: Post-processing and Filtering 

```{r, echo=F, include=T, out.width="100%"}
dir <- "figures/preprocessingMinfiEwasWater/metrics/"
...
```{r, echo=F, include=T, out.width="50%"}
dir <- "figures/methylationGLMM_T1T2/"
